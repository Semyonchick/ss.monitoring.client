...
Health endpoint проверяет регистрацию heartbeat-агента и восстанавливает его, если строка агента отсутствует или отключена. Сам endpoint не обновляет heartbeat: при остановке cron или зависании очереди состояние scheduler останется `critical`.
